<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gestao_utilizadores.aspx.cs" Inherits="lojaonline.gestao_utilizadores" %>
...
<body class="goto-here">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown04">
                ...
                <a class="dropdown-item" href="product-single.html">Produto</a>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.aspx">Home</a></span> <span>Gestão de Utilizadores</span></p>
            <h1 class="mb-0 bread">Gestão de Utilizadores</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="ftco-section bg-light" >
                      ...
                      <asp:Repeater ID="Repeater1" runat="server" DataSourceID="SqlDataSource1" OnItemDataBound="Repeater1_ItemDataBound" OnItemCommand="Repeater1_ItemCommand" ><HeaderTemplate>
                    <table class="display123">
                        <tr style="background-color:black; color:white;">
                            ...
                            <td><b>Status</b></td>
                            <td></td>
                            <td><asp:ImageButton ID="img_saveAll" ImageUrl="~/images/save_all.png" runat="server" OnClick="img_saveAll_Click"/></td>
                        </tr>
                </HeaderTemplate>
                <ItemTemplate>
                    <tr>
                            ...
                            <td>
                                <asp:TextBox ID="tb_perfil" runat="server"></asp:TextBox></td>
                            <td>
    	   ...
    	   <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:lojaonlineConnectionString %>" SelectCommand="SELECT [id_utilizador], [nome_utilizador], [telefone], [email], [nif], [endereco], [id_tipo], [ativacao], [data_nascimento], [genero] FROM [utilizadores]"></asp:SqlDataSource>
