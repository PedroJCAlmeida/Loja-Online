<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registo.aspx.cs" Inherits="lojaonline.registo" %>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.aspx">Home</a></span> <span>Registo</span></p>
            <h1 class="mb-0 bread">Registo</h1>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="col-md-6 order-md-last d-flex">
            <div action="#" class="bg-white p-5 contact-form">
              <div class="form-group">
                <asp:TextBox ID="tb_nome" runat="server" class="form-control" placeholder="Nome" ></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="tb_nome" ErrorMessage="Nome Obirgatório" ForeColor="Red">*</asp:RequiredFieldValidator>
              </div>
               <div class="form-group">
                <asp:TextBox ID="tb_email" runat="server" class="form-control" placeholder="E-mail" ></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="tb_email" ErrorMessage="E-mail Obirgatório" ForeColor="Red">*</asp:RequiredFieldValidator>
               ...
               <div class="form-group">
                <asp:TextBox ID="tb_data_nascimento" TextMode="Date" runat="server" class="form-control" placeholder="Data Nascimento" ></asp:TextBox>
               </div>                  
               <div class="form-group">
                <asp:TextBox ID="tb_telemovel" runat="server" class="form-control" placeholder="N° Telefone" ></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="tb_telemovel" ErrorMessage="Telefone Obirgatório" ForeColor="Red">*</asp:RequiredFieldValidator>
               </div>
               <div class="form-group">
                <asp:TextBox ID="tb_nif" MaxLength="9" runat="server" class="form-control" placeholder="NIF" ></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="tb_nif" ErrorMessage="NIF Obirgatório" ForeColor="Red">*</asp:RequiredFieldValidator>
               </div>
               <div class="form-group">
                <asp:TextBox ID="tb_endereco" runat="server" class="form-control" placeholder="Endereço" ></asp:TextBox>
               </div>
               <div class="form-group">
               <div class="form-control">Gênero:<asp:RadioButtonList ID="rbtn_genero" runat="server"  RepeatDirection="Horizontal" Height="16px" Width="401px">
                       <asp:ListItem>Masculino</asp:ListItem>
                       <asp:ListItem>Feminino</asp:ListItem>
                       <asp:ListItem>Neutro</asp:ListItem>
                   </asp:RadioButtonList>
                   </div> 
               </div>
               <div class="form-group">
                <asp:TextBox ID="tb_pw"  TextMode="Password" runat="server" class="form-control" placeholder="Palavra-Passe"  ></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="tb_pw" ErrorMessage="Palavra-Passe Obirgatório" ForeColor="Red">*</asp:RequiredFieldValidator>
               </div>
               <div class="form-group">
                <asp:TextBox ID="tb_pw_confirm" TextMode="Password" runat="server" class="form-control" placeholder="Confirmar Palavra-Passe" ></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="tb_pw_confirm" ErrorMessage="Confirmar Palavra-Passe Obirgatório" ForeColor="Red">*</asp:RequiredFieldValidator>
               </div>
               ...
               <div class="form-group">
                <asp:Button ID="btn_registar" runat="server" Text="Registar" class="btn btn-primary py-3 px-5" OnClick="btn_registar_Click1"/>
               </div>
