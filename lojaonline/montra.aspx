<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="montra.aspx.cs" Inherits="lojaonline.montra" ValidateRequest="false" %>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.aspx">Home</a></span> <span>Montra</span></p>
            <h1 class="mb-0 bread">Montra</h1>
          </div>
        </div>
      </div>
    </div>
       ...
       <div class="container">
            ...
            Ordernar: <asp:DropDownList   ID="ddl_ordem" runat="server" AutoPostBack="True" >
            <asp:ListItem>------------</asp:ListItem>
            <asp:ListItem>Serviço A-Z</asp:ListItem>
            <asp:ListItem>Serviço Z-A</asp:ListItem>
           ...
           <asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound1"  OnItemCommand="Repeater1_ItemCommand" DataSourceID="SqlDataSource1" Visible="true" >
               <HeaderTemplate>
                    	...
                    	<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
		    				<div class="product d-flex flex-column">
		    					...
		    					<div class="text py-3 pb-4 px-3">
		    						...
		    						<h3><a href="#">
                                        <asp:Label ID="lbl_nome_servico" runat="server" Text=""></asp:Label></a></h3>
		    						<div class="pricing">
    	   ...
    	   <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:lojaonlineConnectionString %>" SelectCommand="SELECT * FROM [produtos]">
           </asp:SqlDataSource>

              <asp:Repeater ID="Repeater2" runat="server" OnItemDataBound="Repeater1_ItemDataBound1" OnItemCommand="Repeater1_ItemCommand" DataSourceID="SqlDataSource2" Visible="false" >
               <HeaderTemplate>
           ...
           <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:lojaonlineConnectionString %>" SelectCommand="select id_produto, nome_produto, valor, foto from produtos order by nome_produto"></asp:SqlDataSource>
         
                            <asp:Repeater ID="Repeater3" runat="server" OnItemDataBound="Repeater1_ItemDataBound1" OnItemCommand="Repeater1_ItemCommand" DataSourceID="SqlDataSource3" Visible="false" >
               <HeaderTemplate>
    		...
    		<div class="row">
              ...
              <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:lojaonlineConnectionString %>" SelectCommand="select id_produto, nome_produto, valor, foto from produtos order by nome_produto desc"></asp:SqlDataSource>
              
                            <asp:Repeater ID="Repeater4" runat="server" OnItemDataBound="Repeater1_ItemDataBound1" OnItemCommand="Repeater1_ItemCommand" DataSourceID="SqlDataSource4" Visible="false" >
               <HeaderTemplate>
    		...
    		<div class="row">
              ...
              <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:lojaonlineConnectionString %>" SelectCommand="select id_produto, nome_produto, valor, foto from produtos order by valor"></asp:SqlDataSource>
              
                            <asp:Repeater ID="Repeater5" runat="server" OnItemDataBound="Repeater1_ItemDataBound1" OnItemCommand="Repeater1_ItemCommand" DataSourceID="SqlDataSource5" Visible="false" >
               <HeaderTemplate>
    		...
    		<div class="row">
              ...
              <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:lojaonlineConnectionString %>" SelectCommand="select id_produto, nome_produto, valor, foto from produtos order by valor desc "></asp:SqlDataSource>
