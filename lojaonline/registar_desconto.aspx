<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registar_desconto.aspx.cs" Inherits="lojaonline.registar_desconto" %>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.aspx">Home</a></span> <span>Inserir Serviços</span></p>
            <h1 class="mb-0 bread">Inserir Desconto</h1>
          </div>
        </div>
      </div>
    </div>
       ...
       <section class="ftco-section bg-light" >
           <div class="display123">
          <b>Código Desconto: </b> <asp:TextBox ID="tb_cod_desconto" runat="server" Width="200px"></asp:TextBox> &nbsp;&nbsp;<asp:Button ID="btn_gerar_cupom" runat="server" Text="Gerar" Width="108px" class="btn btn-primary py-4 px-4" OnClick="btn_gerar_cupom_Click"/>
               <br />
               <br />
            <b>Data Início: </b> <asp:TextBox ID="tb_dt_inicio" runat="server" Width="108px" TextMode="Date"></asp:TextBox>
               <br />
               <br />
            <b>Data Fim: </b> <asp:TextBox ID="tb_dt_fim" runat="server" Width="108px" TextMode="Date"></asp:TextBox>
               <br />
               <br />
          <b>Desconto(%) : </b> <asp:TextBox ID="tb_valor_desconto" runat="server" Width="100px"></asp:TextBox>
               <br />
               <br />
               <br />
               ...
               <div class="form-group">
                <asp:Button ID="btn_registar_desconto" runat="server" Text="Registar Desconto" class="btn btn-primary py-3 px-5" OnClick="btn_registar_desconto_Click"/>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
