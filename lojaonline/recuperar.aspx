      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.aspx">Home</a></span> <span>Recupepara Palavra-Passe</span></p>
     ...
     <div class="row block-9">
          <div class="col-md-6 order-md-last d-flex">
            <div action="#" class="bg-white p-5 contact-form">
              ...
              <div class="form-group">
                <asp:Button ID="btn_recuperar" runat="server" Text="Recuperar" class="btn btn-primary py-3 px-5" OnClick="btn_recuperar_Click"/>
              </div>
              <div class="form-group">
