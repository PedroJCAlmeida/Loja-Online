<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registar_servico.aspx.cs" Inherits="lojaonline.registar_servico"  ValidateRequest="false"%>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <h1 class="mb-0 bread">Inserir Serviços</h1>
          </div>
        </div>
      </div>
    </div>
       ...
       <section class="ftco-section bg-light" >
          ...
          <b>Nome do Serviço: </b> <asp:TextBox ID="tb_nome_servico" runat="server" Width="385px"></asp:TextBox>
               <br />
               <br />
            <b>Preço: </b> <asp:TextBox ID="tb_valor" runat="server" Width="108px" ></asp:TextBox>
               <br />
               <br />
          <b>Selecionar Imagem:&nbsp; </b>    &nbsp;<asp:FileUpload ID="FileUpload1" runat="server" />
            ...
            <b>Descrição do Serviço: </b> 
               <br /> <br />
               <script src="ckeditorhtml/ckeditorhtml/ckeditor.js"></script>
               <asp:TextBox ID="tb_descricao" runat="server" Height="110px" TextMode="MultiLine" Width="569px"></asp:TextBox>
           <script>
               CKEDITOR.replace('<%= tb_descricao.ClientID%>',
                   {
                       curstomConfig: 'custom/editor_config.js'
                   }
               ...
               <div class="form-group">
                <asp:Button ID="btn_registar_servico" runat="server" Text="Registar Serviço" class="btn btn-primary py-3 px-5" OnClick="btn_registar_servico_Click"/>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
