<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="lojaonline.login" %>
     ...
     <div class="row block-9">
          <div class="col-md-6 order-md-last d-flex">
            <div action="#" class="bg-white p-5 contact-form">
              ...
              <div class="form-group">
                  Não tem conta? <asp:LinkButton ID="lbtn_cadastro" runat="server" OnClick="lbtn_cadastro_Click" >Crie uma</asp:LinkButton>
              </div>
              <div class="form-group">
                  Esqueceu a Palavra-Passe? <asp:LinkButton ID="lbtn_recuperarPw" runat="server" OnClick="lbtn_recuperarPw_Click">Recuperar</asp:LinkButton>
              </div>
                              

              <div class="form-group">
                <asp:Button ID="btn_login" runat="server" Text="Login" class="btn btn-primary py-3 px-5" OnClick="btn_login_Click" />
